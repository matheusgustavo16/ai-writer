        ...
        <LayoutDash>
            ...
            <div className="w-full flex justify-between items-start gap-4">
                <div className="w-full">
                    ...
                    <strong className="font-medium select-none text-xs text-gray-500">{userInput.length||0}/250</strong>
                    <button disabled={isGenerating} onClick={callGenerateEndpoint} className="w-full p-2 flex justify-center items-center gap-3 select-none border-2 rounded-md px-4 text-sm bg-[#26FF7C] hover:border-[#129c49] disabled:opacity-50 disabled:cursor-not-allowed transition duration-300 ease-in-out">
