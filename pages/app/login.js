...
const LoginPage = () => {
    ...
    return (<>
        ...
        {loading && <div role="status" className="w-full h-screen flex justify-center items-center">
            <svg aria-hidden="true" class="w-16 h-16 text-white text-opacity-75 animate-spin dark:text-gray-600 fill-[#26FF7C]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
